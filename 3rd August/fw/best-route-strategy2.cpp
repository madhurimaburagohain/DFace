...
//--------------------------------------------------------------------------------------------------
        find_face(fibEntry, interest);
        
        //getFaceForForwarding(fibEntry, nexthops, interest, ingress.face);
...
void BestRouteStrategy2::find_face(const fib::Entry& fibEntry, const Interest& interest)
{
       // std::cout << " Looking for a  face for " << fibEntry.getPrefix() << " via percentage usage" <<  "\n";
...
/*void BestRouteStrategy2::getFaceForForwarding(const fib::Entry& fibEntry, const fib::NextHopList& nexthops,
