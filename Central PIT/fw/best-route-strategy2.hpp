...
public:
  ...
  void find_face(const fib::Entry& fibEntry, const Interest& interest);
  
  
//  void getFaceForForwarding(const fib::Entry& fibEntry, const fib::NextHopList& nexthops, const Interest& interest, const Face& inFace);
