...
void onReductionPITEntry();
 static void TraceInfo1 ( ns3::Ptr<ns3::Node> node,ns3::Time next);
...
private:
  ...
  long int total_interest, total_data, restime, rescount, interest_prefix;
  std::unordered_map <std::string, int> prefix_mark_map;
    std::unordered_map <std::string, double> prefix_isr_map;
     std::unordered_map <std::string, int> prefix_interest_map;
     std::unordered_map <std::string, int> prefix_data_map;
     
     std::unordered_map <std::string, int> prefix_pitEntry_map;
     
    // std::unordered_map <std::string, std::pair (int, int)> prefix_mark_info_map;
